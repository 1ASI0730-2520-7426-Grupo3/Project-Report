...
| US19          | Recibir facturas y recibos                      | T02                | Generación de facturas y documentos       | Generación de PDFs, almacenamiento, endpoints y estructura de historial de transacciones.    | 8h         | Wilder Aliaga        | Done   |
| US20          | Recibir recordatorios de pago                   | T03                | Sistema de recordatorios automáticos      | Implementación de recordatorios programados, lógica de fechas y mensajes del backend.        | 6h         | Wilder Aliaga        | Done   |
| US03          | Programar mantenimientos preventivos            | T04                | Lógica de programación de mantenimientos  | Scheduling, creación de solicitudes y validaciones del módulo de mantenimiento.              | 8h         | Wilder Aliaga        | Done   |
| US04          | Consultar historial de incidencias              | T05                | Historial y registros de mantenimiento     | Implementación de endpoints para obtener historial completo de incidencias.                 | 6h         | Wilder Aliaga        | Done   |
| US12          | Gestionar órdenes de trabajo                    | T06                | Flujo de órdenes de mantenimiento         | Creación, asignación, estados y notificaciones de órdenes de trabajo.                        | 8h         | Anderson Ventosilla  | Done   |
...
| US31          | Ver el estado de mi solicitud                   | T12                | Listado y seguimiento de solicitudes       | Implementación del tracking de estados: Pendiente, Aceptada, Rechazada.                      | 6h         | Anderson Ventosilla  | Done   |
...
| US33          | Aceptar o rechazar una solicitud                | T14                | Acciones de aprobación / rechazo          | Implementación de endpoints y UI para cambiar estado y notificar al cliente.                 | 5h         | Anderson Ventosilla  | Done   |
